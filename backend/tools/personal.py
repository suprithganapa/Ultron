"""Personal-ops tools: notes, tasks, reminders — persisted in SQLite."""
...
def complete_task(task_id: int) -> str:
    ok = memory.complete_task(int(task_id))
...
def add_reminder(text: str, in_minutes: float = 30) -> str:
    ...
    rid = memory.add_reminder(text, due)
